...
| --- | -------------------------------------------- | ---------------------------- | ---------------------------------------------------------- | ---------------------------------------------------------------------- | -------------------- | ---------------------------------------------------------- | ---- | -------------- |
| D1  | Total de jogadores online (com auto-refresh) | Contador na home             | Rubinot                                                    | [https://rubinot.com.br/api/worlds](https://rubinot.com.br/api/worlds) | —                    | Exemplo da response em tests/fixtures/worlds-response.json        | -    | OK             |
...
| D5  | Dados de personagem (busca)                  | Campo "busca por personagem" | Rubinot                                                    | `?` (ex.: `/character/{nome}`)                                         | `nome` do personagem | JSON exemplo da response em tests/fixtures/character-details.json | ?    | 🔴 A confirmar |
